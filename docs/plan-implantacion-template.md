...
<!-- 📝 Arquitectura del software, servicios que lo componen, sistema operativo seleccionado,
matriz de requisitos mínimos (CPU, RAM, disco, red) y resultado del script de verificación. -->
